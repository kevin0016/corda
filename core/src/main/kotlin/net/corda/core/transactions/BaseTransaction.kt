...
abstract class BaseTransaction(
    ...
    protected fun checkInvariants() {
        ...
        if (timeRange != null) check(notary != null) { "If a time-range is provided, there must be a notary." }
    }
    ...
    override fun hashCode() = Objects.hash(notary, mustSign, type, timeRange)
