...
//        fun registerFlowFactory(initiatingFlowClass: KClass<out FlowLogic<*>>,
//                                  flowVersion: Int = initiatingFlowClass.java.flowVersion,
//                                  flowFactory: (Party) -> FlowLogic<*>) {
//            flowFactories[initiatingFlowClass.java] = InitiatedFlowInfo.CorDapp(flowVersion, flowFactory)
//        }
