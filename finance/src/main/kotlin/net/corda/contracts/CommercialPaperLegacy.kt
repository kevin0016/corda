...
class CommercialPaperLegacy : Contract {
    ...
    override fun verify(tx: TransactionForContract) {
        ...
        val timeRange: TimeRange? = tx.timeRange
        ...
        for ((inputs, outputs, key) in groups) {
            when (command.value) {
                ...
                is Commands.Redeem -> {
                    ...
                    val time = timeRange?.fromTime ?: throw IllegalArgumentException("Redemptions must have a time-range (validation window)")
                    requireThat {
                ...
                is Commands.Issue -> {
                    ...
                    val time = timeRange?.untilTime ?: throw IllegalArgumentException("Issuances have a time-range (validation window)")
                    requireThat {
