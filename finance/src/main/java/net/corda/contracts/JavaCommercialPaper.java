    ...
    public interface Clauses {
        ...
        class Redeem extends Clause<State, Commands, State> {
            ...
            public Set<Commands> verify(@NotNull TransactionForContract tx,
                ...
                TimeRange timeRange = tx.getTimeRange();
                Instant time = null == timeRange
                        ? null
                        : timeRange.getUntilTime();
                Amount<Issued<Currency>> received = CashKt.sumCashBy(tx.getOutputs(), input.getOwner());

                requireThat(require -> {
                    require.using("must be timestamped", timeRange != null);
        ...
        class Issue extends Clause<State, Commands, State> {
            ...
            public Set<Commands> verify(@NotNull TransactionForContract tx,
                ...
                TimeRange timeRangeCommand = tx.getTimeRange();
                Instant time = null == timeRangeCommand
                        ? null
                        : timeRangeCommand.getUntilTime();
                ...
                requireThat(require -> {
                    ...
                    require.using("must be timestamped", timeRangeCommand != null);
